...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-[#020022] pt-16 pb-0 px-6 border-t border-white/5 overflow-hidden">
      ...
      <div className="absolute -bottom-24 left-1/2 -translate-x-1/2 w-[60%] h-48 bg-[#FECC00]/5 blur-[120px] rounded-full pointer-events-none"></div>
      ...
      >
        ...
        <div className="pt-6 pb-6 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
  ...
  const content = (
    <>
      ...
      <div className="flex-1 flex flex-col justify-center">
        ...
        <p className={`text-white mb-2 font-display group-hover:text-[#FECC00] transition-colors duration-500 ${valueClassName ?? 'text-[20px] font-medium'}`}>
          {value}
        </p>
        {subValue && (
